...
public class DebugUI : MonoBehaviour
{
    ...
    private void Start()
    {
        renderDistanceSlider.value = dataOrigin.chunkManager.viewDistance;
    }
    ...
    void Update()
    {
        ...
        renderDistance.text = dataOrigin.chunkManager.viewDistance.ToString();
        fps.text = ((int)(1f/Time.smoothDeltaTime)).ToString();
    }

    public void UpdateRenderDistance()
    {
        dataOrigin.chunkManager.viewDistance = (int)renderDistanceSlider.value;
    }
}
